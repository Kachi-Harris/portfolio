            ...
            >
              ...
              <div className="space-y-5 text-foreground">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">harrisanyanwu24@gmail.com</span>
                  <button
                    onClick={() => copyToClipboard('harrisanyanwu24@gmail.com', 'Email')}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">+44 7377 923189</span>
                  <button
                    onClick={() => copyToClipboard('+447377923189', 'Phone number')}
                    className="text-muted-foreground hover:text-primary transition"
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">Rainham, United Kingdom</span>
                </div>
              </div>
            </motion.div>
