...
const ResumeSection = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-3xl sm:text-4xl font-bold text-primary tracking-tight">Curriculum Vitae</h2>
        <p className="mt-2 text-muted-foreground text-sm italic">
          Full resume of Kachi Harris — Senior DevOps & Platform Engineer.
        </p>
      </motion.div>
