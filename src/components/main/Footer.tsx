...
const Footer: FC = () => {
  ...
  const quickLinks = ['About', 'Skills', 'Experience', 'Contact']
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <motion.div className="space-y-4" variants={childVariants}>
            <h1 className="text-2xl font-extrabold bg-clip-text">Kachi Harris</h1>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Senior DevOps & Platform Engineer — building reliable cloud platforms, GitOps pipelines and robust observability.
            </p>
          </motion.div>
        ...
        <motion.div
          ...
          animate="visible"
        >
          <p className="text-xs text-muted-foreground">© {new Date().getFullYear()} Kachi Harris.</p>
